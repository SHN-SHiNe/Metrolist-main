...
import com.metrolist.music.ui.screens.comments.SongCommentsScreen
...
import com.metrolist.music.ui.screens.search.ChinaSonglistScreen
...
fun NavGraphBuilder.navigationBuilder(
    ...
    composable(
        route = "search_input_with_query?q={q}&source={source}",
        arguments = listOf(
            navArgument("q") {
    ...
    composable(
        route = "artist/{artistId}?isPodcastChannel={isPodcastChannel}&name={name}",
        arguments =
            listOf(
    ...
    composable(
        route = "artist/{artistId}/online?name={name}",
        arguments =
            listOf(
                navArgument("artistId") {
                    type = NavType.StringType
    ...
    composable(
        route = "china_search/{query}?type={type}",
        arguments = listOf(
        ...
        ChinaSearchScreen(
            navController = navController,
            initialQuery = backStackEntry.arguments?.getString("query"),
            searchType = backStackEntry.arguments?.getString("type") ?: "song",
        )
    }

    composable(
        route = "china_songlist/{source}/{id}?name={name}",
        arguments = listOf(
        ...
        ChinaSonglistScreen(navController)
    }

    composable(route = "china_source_select") {
        ChinaSourceSelectScreen(navController)
    }

    composable(
        route = "china_board/{source}/{bangid}?name={name}",
        arguments = listOf(
            navArgument("source") { type = NavType.StringType },
            navArgument("bangid") { type = NavType.StringType },
            navArgument("name") {
                type = NavType.StringType
                defaultValue = ""
            },
        ...
        ChinaBoardScreen(navController)
    }

    composable(
        route = "china_tag_songlists/{source}/{tag}?name={name}",
        arguments = listOf(
            navArgument("source") { type = NavType.StringType },
        ...
        ChinaTagSonglistsScreen(navController)
    }

    composable(
        route = "song_comments?mediaId={mediaId}",
        arguments = listOf(
        ...
        SongCommentsScreen(
            navController = navController,
            mediaId = it.arguments?.getString("mediaId").orEmpty(),
        )
    }
    ...
    composable("settings/china_music_source") {
        ChinaMusicSourceSettings(navController)
    }
