...
import com.metrolist.music.ui.component.ImportNetworkPlaylistDialog
...
fun LibraryPlaylistsScreen(
    ...
    val likedThumbnails by viewModel.likedThumbnails.collectAsStateWithLifecycle()
    val downloadedThumbnails by viewModel.downloadedThumbnails.collectAsStateWithLifecycle()
    val topThumbnails by viewModel.topThumbnails.collectAsStateWithLifecycle()
    ...
    var showImportNetworkPlaylistDialog by rememberSaveable { mutableStateOf(false) }
    ...
    if (showImportNetworkPlaylistDialog) {
        ImportNetworkPlaylistDialog(
            onDismiss = { showImportNetworkPlaylistDialog = false },
            onPlaylistImported = { playlistId ->
                showImportNetworkPlaylistDialog = false
                navController.navigate("local_playlist/$playlistId")
            }
        )
    }
        ...
        Box(
            ...
            DropdownMenu(
                ...
                DropdownMenuItem(
                    ...
                    onClick = {
                        showFabMenu = false
                        showImportNetworkPlaylistDialog = true
                    },
                )
            }
        }
